...
void _chasis::draw(Modo modo, float r1, float g1, float b1, float r2, float g2, float b2, float grosor){
...
glRotatef(90,1,0,0);
rodamientos.draw(modo,r1,g1,b1,r2,g2,b2,grosor);
glPopMatrix();
...
void _cabina::draw(Modo modo, float r1, float g1, float b1, float r2, float g2, float b2, float grosor){
base.draw(modo,r1,g1,b1,r2,g2,b2,grosor);
...
void _brazo::draw(Modo modo, float r1, float g1, float b1, float r2, float g2, float b2, float grosor){
glPushMatrix();
glTranslatef(0,0,-0.25);
glRotatef(-45,0,0,1);
glRotatef(6,1,0,0);
barras.draw(modo,r1,g1,b1,r2,g2,b2,grosor);
glPopMatrix();
...
void _cuerda::draw(Modo modo, float r1, float g1, float b1, float r2, float g2, float b2, float grosor){
glPushMatrix();
glTranslatef(0,-2,0);
glPushMatrix();
...
void _bola::draw(Modo modo, float r1, float g1, float b1, float r2, float g2, float b2, float grosor){
glPushMatrix();
glTranslatef(0,-0.25,0);
glPushMatrix();
b.draw(modo,r1,g1,b1,r2,g2,b2,grosor);
glPopMatrix();
glPopMatrix();
}
...
void _demoledor::draw(Modo modo, float r1, float g1, float b1, float r2, float g2, float b2, float grosor){
glPushMatrix();
...
cuerda.draw(modo,r1,g1,b1,r2,g2,b2,grosor);
